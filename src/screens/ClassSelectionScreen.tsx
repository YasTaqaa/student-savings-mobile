...
export default function ClassSelectionScreen({ navigation }: Props) {
  ...
  const getStudentCount = (grade: string) => {
  ...
  const classes = [
    { grade: 'ALL', label: 'Semua Kelas', icon: '📚', color: colors.primary },
    ...
    { grade: '4A', label: 'Kelas 4A', icon: '4️⃣', color: '#95E1D3' },
    { grade: '4B', label: 'Kelas 4B', icon: '4️⃣', color: '#6BCB77' },

    { grade: '5', label: 'Kelas 5', icon: '5️⃣', color: '#F38181' },

    { grade: '6A', label: 'Kelas 6A', icon: '6️⃣', color: '#AA96DA' },
    { grade: '6B', label: 'Kelas 6B', icon: '6️⃣', color: '#845EC2' },
  ];
      ...
      <View style={common.p5}>
            ...
            return (
              ...
              >
                <View style={[common.flexRow, common.itemsCenter, { gap: 12 }]}>
                  ...
                  >
                    <Text style={{ fontSize: 28 }}>{cls.icon}</Text>
                  </View>
        ...
        >
          ...
          >
            ...
            atau pilih kelas tertentu untuk memfilter data
          </Text>
        </View>
      </View>
    </ScrollView>
